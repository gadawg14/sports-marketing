<?php
	...
	$id=$_POST['id'];
		...
		$pupdsql = "update bbregistrations set paid='" . $_POST['paid'] . 
        ...
        //$pupdsql = mysql_real_escape_string($ppdsql);
...
<?php
					...
					while($row = mysql_fetch_array($sql)){ 
						...
						echo '<form action="ad_esmmain.php?i=ad_bbcampdetail.php" method="POST" style="font: 9pt/9pt arial, tahoma; margin-left: 5px;">';
						echo '<br><Br>';
