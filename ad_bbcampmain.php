...
$dataquery = "select * FROM bbcamp f 
						order by f.date asc";
...
echo '<div style="float: left; margin-bottom: 30px;">';
	echo '<a href="ad_esmmain.php?i=ad_bbcampadd.php&as=a">Add New Camp</a>';
echo '</div>';
...
while($row = mysql_fetch_array($sql)){ 
    ...
    echo '<td width="80"><a href="ad_esmmain.php?i=ad_bbcampreglist.php&id=' . $row['id'] . '">Reg List</td>';
    echo '<td><a href="ad_esmmain.php?i=ad_bbcampmtopt.php&id=' . $row['id'] . '">Add Payment Options</td>';
    echo '</tr>';
} 
